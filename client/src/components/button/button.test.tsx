...
test('button register button click', () => {
  ...
  const button = shallow((<Button onPress={mockCallBack}>Button Content</Button>));
...
test('pressing a disabled button', () => {
  ...
  const button = shallow((<Button disabled={true} onPress={mockCallBack}>Button Content</Button>));
  button.simulate('click');
