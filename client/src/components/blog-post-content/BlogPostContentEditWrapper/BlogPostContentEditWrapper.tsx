...
const BlogPostContentEditWrapper: FC<BlogPostContentEditWrapperProps> = (props) => {
    ...
    return (
        <div className={"blog-post-content-edit-wrapper__container " + (isDeleted ? " blog-post-content-edit-wrapper__container--deleted" : "")}>
            <div className="blog-post-content-edit-wrapper__action-container">
                <div className="blog-post-content-edit-wrapper__action-buttons">
                    <div onClick={onDeletePressed} className="blog-post-content-edit-wrapper__delete">
