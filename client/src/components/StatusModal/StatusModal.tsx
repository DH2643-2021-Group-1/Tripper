  ...
  return (
    <Card>
      <div className={"status-modal " + statusModalClassStates.join(" ")}>
        <div className="status-modal__icon-container">{renderIcon()}</div>
        <div className="status-modal__line-split"></div>
        <div className="status-modal__text-container">
          <div className="status-modal__title">{props.title}</div>
          <div className="status-modal__description">{props.children}</div>
        </div>
      </div>
    </Card>
  );
