...
const ImageInput = ({
  ...
  return !uploaded ? (
    <div
      className={
        !isMissing
          ? "image-input__image-uploader-default"
          : "image-input__image-uploader-required"
      }
    >
      <div className={""}>
      ...
      <input
        className="image-input__hide-image"
        type="file"
        id="single"
    ...
    <div
      ...
      className={
        !isMissing
          ? "image-input__image-uploader-no-border"
          : "image-input__image-uploader-required"
      }
    >
      ...
      {imageUrl && (
        <img
          className="image-input__preview-image"
          src={imageUrl}
          alt="preview image"
        />
      )}
